              ...
              <form>
                <div className='row'>
                  <div class="form-group col-sm-4 ">
                    ...
                    <input type="text" class="form-control" id="recipient-name" style={{ background: "#E7EEF0", border: "1px solid #18566B" }} />
                  </div>
                  <div class="form-group col-sm-4">
                ...
                <div class=" row  " >
                  ...
                  <div className='form-group col-sm-3 '>
                    ...
                    <label class="checkbox-inline col-form-label " >
                      <input type="checkbox" value="" /><span>&nbsp;&nbsp;&nbsp;</span> Individual
                    </label>
                  </div>
                  <div className='form-group col-sm-3'>
                    <label class="checkbox-inline col-form-label">
                      <input type="checkbox" value="" /><span>&nbsp;&nbsp;&nbsp;</span> Group
                    </label>
                  </div>
                  <div className='form-group col-sm-3'>
                    <label class="checkbox-inline col-form-label">
                      <input type="checkbox" value="" /> <span>&nbsp;&nbsp;&nbsp;</span> Corporate
                    </label>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" id="message-text" style={{ background: "#E7EEF0", border: "1px solid #18566B" }}></textarea>
                </div>
              </form>
            </div>
