...
import ibm from "../../Assets/Image/cert.png"
import pdf from "../../Assets/pdf/AWS.pdf"
...
const Aws = () => {
  ...
  return (
    ...
    <div class="p-5  bg-image bckgroundcertificate">
              ...
              <div class="container-fluid">
                <div class="row p-5">
                  ...
                  <div class="col-sm-8 py-5 text-white ">
                    <h4 className='cname'>Amazon Web Services (AWS) Authorized Training</h4>
                    <p className='pt-4 cname'>Master all aspects of Amazon Web Services (AWS) with training in AWS Cloud Practitioner Essentials, Developing on AWS, Systems Operations on AWS and more.Learn the skills you need to gain an in-depth understanding of Amazon Web Services (AWS) with our hands-on training & expert trainers.
                    </p>
                    <hr />
     ...
     <div className='row'>
    <div className='col-9'>
        <h4 >AWS OEM Offerings</h4>
    <h6>The Following pdf contains all the AWS Certification course details offered.</h6>
    </div>
    <div className='col-3'>
