...
import ibm from "../../Assets/Image/in.png"
...
const Informatica = () => {
  ...
  return (
    ...
    <div class="p-5  bg-image bckgroundcertificate">
              ...
              <div class="container-fluid">
                <div class="row p-5">
                  <div class="col-sm-6 p-5 ">
                    ...
                    <button type="button" class=" enquirybutton mt-5" data-toggle="modal" data-target=".bd-example-modal-lg">Enquire Now</button>
                  </div>
                  <div class="col-sm-6 py-5 text-white ">
                    <h4 className='cname'>Informatica Authorized Training</h4>
                    <p className='pt-4 cname'>Alchemy Solutions is a training organisation with a broad range of resources, particularly for Informatica Products. Our headquarters are in Bangalore, and we have offices in Hyderabad, Chennai, Mumbai, Gurgaon, and Noida. We also provide our clients with top-notch training infrastructure, and our commitment to quality is what places us as India's top training vendor.
                    </p>
                    <hr />
     ...
     <div className='row'>
    <div className='col-9'>
        <h4 >Informatica OEM Offerings</h4>
    <h6>The Following pdf contains all the Informatica Certification course details offered.</h6>
    </div>
    <div className='col-3'>
    ...
    border: "none"}}>View Details</button>
    </div>
