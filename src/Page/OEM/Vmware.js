...
import ibm from "../../Assets/Image/vmware-logo.jpg"
import pdf from "../../Assets/pdf/Vmware.pdf"
...
const Vmware = () => {
  ...
  return (
    ...
    <div class="p-5  bg-image bckgroundcertificate">
     ...
     <div className='row'>
    <div className='col-9'>
        <h4 >Vmware OEM Offerings</h4>
    <h6>The Following pdf contains all the Vmware Certification course details offered.</h6>
    </div>
    <div className='col-3'>
